...
public class CongestionTaxCalculatorServiceTest {
    ...
    public void shouldReturnZeroWhenEmptyInput() throws ParseException {
        ...
        TaxCalculatorRequest request = createRequest("Car", dateTime);
        Mockito.when(cityRepository.findByName("Gothenburg")).thenReturn(getEmptyVehicleResponse());
        TaxCalculatorResponse result = congestionTaxCalculatorService.calculateTax(request.getVehicle(), request.getCheckInTime(), "Gothenburg");
    ...
    public void shouldReturnSuccessForMultipleDateTimes() throws ParseException {
        ...
        TaxCalculatorRequest request = createRequestMultipleDates("Car", dateList);
        Mockito.when(cityRepository.findByName("Gothenburg")).thenReturn(getVehicleResponse());
        TaxCalculatorResponse result = congestionTaxCalculatorService.calculateTax(request.getVehicle(), request.getCheckInTime(), "Gothenburg");
        assertThat(result).isNotNull();
    ...
    private TaxCalculatorRequest createRequest(String vehicleType, Date arrivalTimes) throws ParseException {
    ...
    private TaxCalculatorRequest createRequestMultipleDates(String vehicleType, List<Date> dateList) throws ParseException {
        Vehicle vehicle = new Vehicle();
        vehicle.setType(vehicleType);
        TaxCalculatorRequest request = new TaxCalculatorRequest();
        request.setCheckInTime(dateList);
